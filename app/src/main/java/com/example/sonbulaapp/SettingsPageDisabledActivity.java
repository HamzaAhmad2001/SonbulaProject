...
public class SettingsPageDisabledActivity extends AppCompatActivity {
    ...
    {
        Intent intentbtn_editProfile=new Intent(SettingsPageDisabledActivity.this, EditDisabledProfileActivity.class);
    ...
    {
        Intent intentBtn_ProfileVolunteer=new Intent(SettingsPageDisabledActivity.this, DisabledProfileActivity.class);

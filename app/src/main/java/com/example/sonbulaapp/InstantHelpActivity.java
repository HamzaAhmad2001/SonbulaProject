...
public class InstantHelpActivity extends AppCompatActivity {
   ...
   public void openFindingVolunteer()
    {
        Intent intent = new Intent(InstantHelpActivity.this, InstantHelpActivity.class);
    ...
    {
        Intent intent = new Intent(InstantHelpActivity.this, DisabledProfileActivity.class);
        startActivity(intent);
    }
    ...
    {
        Intent intent = new Intent(InstantHelpActivity.this, DisabledHomeActivity.class);
        startActivity(intent);
    }
    public void openArchive()
    {
        Intent intent = new Intent(InstantHelpActivity.this, /* Archive صفحة مش موجودة*/DisabledProfileActivity.class);
        startActivity(intent);
    }
    public void openSettings()
    {
        Intent intent = new Intent(InstantHelpActivity.this, SettingPageVolunteerActivity.class);
        startActivity(intent);
    }
